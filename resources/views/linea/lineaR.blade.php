...
<!-- Esto es lo que vale-->
  <li>
    <time class="cbp_tmtime" datetime="2013-04-10 18:30"><span>4/10/13</span> <span>20:30</span></time>
    <div class="cbp_tmicon cbp_tmicon-phone"></div>
    <div class="cbp_tmlabel">
      <h2>Trabajo algo con R</h2>
      <p>Este trabajo fue realizado lalla lalala lalala allala alal alalala alalala lalaa lala alala alla alla alala alla</p>
    </div>
  </li>
<!-- Esto es lo que vale-->
  <li>
